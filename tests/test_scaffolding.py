...
def test_decision_seed_set_present():
    ...
    # 13-16 are the Patron's recorded rulings (2026-09-19); 17 is the
    # portability charter (Patron direction 2026-09-20). The equality
    # still guards against holes and strays.
    expected = [f"DEC-{n:04d}.md" for n in range(1, 18)]
